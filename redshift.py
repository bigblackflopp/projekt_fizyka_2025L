...
def redshift_pixel(r, g, b, z):
    ...
    shifted_wave = dom_wave * (1 + z)

    if shifted_wave > 750:
        return (int(r * 0.4), int(g * 0.1), int(b * 0.1))  # infrared → dark red
    elif shifted_wave < 380:
        return (0, 0, int(b * 0.5))  # UV → dim blue
...
if __name__ == "__main__":
    a = sys.argv[1]
    i = 0
    image_path = a  # replace with your image
